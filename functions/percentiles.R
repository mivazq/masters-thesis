...
p02   <- function (x,na.rm=T) quantile(x, prob=c(0.02),  na.rm=na.rm)
p025  <- function (x,na.rm=T) quantile(x, prob=c(0.025), na.rm=na.rm)
...
p975  <- function (x,na.rm=T) quantile(x, prob=c(0.975), na.rm=na.rm)
p98   <- function (x,na.rm=T) quantile(x, prob=c(0.98),  na.rm=na.rm)
