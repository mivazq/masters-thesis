...
share_AF <- sum(elasticities_V_AF$n)/sum(elasticities_V$n)
share_G  <- sum(elasticities_V_G$n)/sum(elasticities_V$n)
share_HQ <- sum(elasticities_V_HQ$n)/sum(elasticities_V$n)
...
cat("\\toprule \n")
# cat(" & \\multicolumn{3}{c}{Estimation method} \\\\ \n")
# cat("\\addlinespace \\cline{2-4} \\addlinespace \n")
cat(" & FOC & OLS & DLW \\\\ \n")
...
# sink(paste0(pathTab,sysdate,"_table_4_estimates_parameters_V.tex"))
# cat("\\begin{table}[!htbp]\\centering \n")
# cat("\\caption{\\label{tab:EstimatedParametersVIndustryGroup} Estimated Output Elasticities by Estimation Method - Combined Variable Costs} \n")
# cat("\\begin{adjustbox}{width=\\columnwidth,center} \n")
...
# cat("\\addlinespace \\cline{2-4} \\cline{6-8} \\cline{10-12} \\cline{14-16} \\addlinespace \n")
...
# 
# 
# # Appendix table - Cobb Douglas - ML
# sink(paste0(pathTab,sysdate,"_table_4_estimates_parameters_ML.tex"))
# cat("\\begin{table}[!htbp]\\centering \n")
# cat("\\caption{\\label{tab:EstimatedParametersMLIndustryGroup} Estimated Output Elasticities by Estimation Method - Separated Variable Costs} \n")
# cat("\\begin{adjustbox}{width=\\columnwidth,center} \n")
# cat("\\begin{tabular}{lccccccccccccccc}")
# cat("\\toprule \n")
# cat(" & \\multicolumn{3}{c}{A01--F45} & & \\multicolumn{3}{c}{G50--G52} & & \\multicolumn{3}{c}{H55--Q99} & & \\multicolumn{3}{c}{All industries}\\\\ \n")
