...
markups[, c("mu_m_dlw_cd", "mu_v_dlw_cd", "mu_v_dlw_tl", "M", "L", "V_lag") := NULL]
setnames(markups, "mu_m_dlw_tl", "mu")
...
sink(paste0(pathTab,sysdate,"_table_3_regression_results_all_metrics_M.tex"))
cat("\\begin{table}[!htbp]\\centering \n")
cat("\\caption{\\label{tab:EstimatedResults_All_M} Regression Results for All Network Metrics} \n")
...
sink(paste0(pathTab,sysdate,"_table_3_regression_results_all_metrics_weighted_M.tex"))
cat("\\begin{table}[!htbp]\\centering \n")
cat("\\caption{\\label{tab:EstimatedResults_All_weighted_M} Regression Results for All Network Metrics} \n")
cat("\\begin{adjustbox}{width=0.7\\textwidth,center} \n")
cat("\\begin{tabular}{llccc}")
cat("\\toprule \n")
cat(" & & IQR & (1) & (2) \\\\ \n")
