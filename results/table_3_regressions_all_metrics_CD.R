...
markups[, c("mu_m_dlw_cd", "mu_m_dlw_tl", "mu_v_dlw_tl", "M", "L", "V_lag") := NULL]
...
sink(paste0(pathTab,sysdate,"_table_3_regression_results_all_metrics_CD.tex"))
cat("\\begin{table}[!htbp]\\centering \n")
cat("\\caption{\\label{tab:EstimatedResults_All_CD} Regression Results for All Network Metrics} \n")
...
sink(paste0(pathTab,sysdate,"_table_3_regression_results_all_metrics_weighted_CD.tex"))
cat("\\begin{table}[!htbp]\\centering \n")
cat("\\caption{\\label{tab:EstimatedResults_All_weighted_CD} Regression Results for All Network Metrics} \n")
cat("\\begin{adjustbox}{width=0.7\\textwidth,center} \n")
cat("\\begin{tabular}{llccc}")
cat("\\toprule \n")
cat(" & & IQR & (1) & (2) \\\\ \n")
